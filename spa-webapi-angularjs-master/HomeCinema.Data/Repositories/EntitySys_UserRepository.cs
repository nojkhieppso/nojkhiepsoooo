...
{
    public class EntitySys_UserRepository<T> : IEntitySys_UserRepository<T>
            where T : class, IEntitySys_User, new()
    {
        ...
        public EntitySys_UserRepository(IDbFactory dbFactory)
        {
            DbFactory = dbFactory;
        }
        #endregion

...
namespace HomeCinema.Web.Controllers
{
    ...
    {
        private readonly IEntityGuidRepository<Profiler> _customersRepository;
        ...
        public HttpResponseMessage Get(HttpRequestMessage request, string filter)
        {
            ...
            return CreateHttpResponse(request, () =>
            {
                ...
                var customersVm = Mapper.Map<IEnumerable<Profiler>, IEnumerable<CustomerViewModel>>(customers);
        ...
        public HttpResponseMessage Get(HttpRequestMessage request, Guid id)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                CustomerViewModel customerVm = Mapper.Map<Profiler, CustomerViewModel>(customer);
        ...
        public HttpResponseMessage Register(HttpRequestMessage request, CustomerViewModel customer)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    {
                        Profiler newCustomer = new Profiler();
                        newCustomer.UpdateCustomer(customer);
                        _customersRepository.Add(newCustomer);
                        _unitOfWork.Commit();
                        // Update view model
                        customer = Mapper.Map<Profiler, CustomerViewModel>(newCustomer);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, CustomerViewModel customer)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    Profiler _customer = _customersRepository.GetSingle(customer.ID);
        ...
        public HttpResponseMessage Get(HttpRequestMessage request, int? page, int? pageSize, string filter = null)
        {
            ...
            return CreateHttpResponse(request, () =>
            {
                ...
                IEnumerable<CustomerViewModel> customersVM = Mapper.Map<IEnumerable<Profiler>, IEnumerable<CustomerViewModel>>(customers);

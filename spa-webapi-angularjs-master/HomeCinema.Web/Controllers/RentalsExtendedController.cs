...
namespace HomeCinema.Web.Controllers
{
    ...
    public class RentalsExtendedController : ApiControllerBaseExtended
    {
        ...
        public HttpResponseMessage Rent(HttpRequestMessage request, Guid customerId, int stockId)
        {
            _requiredRepositories = new List<Type>() { typeof(Profiler), typeof(Stock), typeof(Rental) };
        ...
        {
            _requiredRepositories = new List<Type>() { typeof(Profiler), typeof(Stock), typeof(Rental), typeof(Profiler), typeof(Movie) };
